...
proc p_plddr3_adcfifo {p_name m_name adc_data_width} {
  ...
  file copy -force $ad_hdl_dir/projects/common/mitx100/mitx100_system_mig.prj "$axi_ddr_cntrl_dir/"
  set_property -dict [list CONFIG.XML_INPUT_FILE {mitx100_system_mig.prj}] $axi_ddr_cntrl
  ...
  set_property -dict [list CONFIG.AXI_DATA_WIDTH {256}] $axi_adcfifo
